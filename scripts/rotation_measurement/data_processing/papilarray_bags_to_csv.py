...
FILE_DIR = '/home/rhys/srp_ws/src/Deep-Tactile-Rotation-Measurement/'
CSV_NAME = 'data'
BAG_DIR = 'box_bags_true/'
...
def main(track_angle_srv, reset_angle_srv):
    ...
    for bag_dir in bag_list:
        ...
        if len(time_data) == len(image_data) == len(tactile_data_0) == len(tactile_data_1):
            df, largeChange = tactile_data_to_df(df, time_data, image_data, tactile_data_0, tactile_data_1, track_angle_srv)
